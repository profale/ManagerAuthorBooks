...
namespace ManagerAuthorBooks.Tests.HandlerTests
{
    ...
    public class CreateAuthorHandlerTests
    {
        ...
        public CreateAuthorHandlerTests(IMapper mapper, IMediatorHandler bus)
        {
            _mapper = mapper;
            _bus = bus;
        ...
        {
            _handler = new AuthorHandler(new FakeAuthorRepository(new DataContext(new DbContextOptions<DataContext>())), _mapper, _bus);
